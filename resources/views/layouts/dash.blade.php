...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/home" class="brand-link">
      <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="Mobidal Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">M O B I D A L</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('logout') }}"
                ...
                <i class="nav-icon far text-danger fas fa-sign-out-alt"></i>
                <p> {{ __('Logout') }} </p> 
             </a>
